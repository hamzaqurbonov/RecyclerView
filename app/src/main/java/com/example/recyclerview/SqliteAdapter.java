...
public class SqliteAdapter  extends RecyclerView.Adapter<SqliteAdapter.ViewHolder>  {
    ...
    private ArrayList<SqliteModel> courseModalArrayList;
    private Context context;

    // constructor
    public SqliteAdapter(ArrayList<SqliteModel> courseModalArrayList, Context context) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.sqlite_item, parent, false);
